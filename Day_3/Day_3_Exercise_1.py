...
# Calculando o resto da divisão do número fornecido pelo
# usuário. Usar o símbolo de %.
result = number%2

# Fazendo o teste lógico se result é par/even ou impar/odd.
if result==0:
    print("This is an even number.")
else:
    print("This is an odd number.")

# Obs.: Even = Par  e Odd = Impar.